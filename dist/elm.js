...
var _elm_lang$elm_architecture_tutorial$Model$initialModel = {intervalLengthMs: 0, t: 0};
var _elm_lang$elm_architecture_tutorial$Model$Model = F2(
	function (a, b) {
		return {intervalLengthMs: a, t: b};
	});

var _elm_lang$elm_architecture_tutorial$Design$element = F2(
	function (j, model) {
		var thetaR = _elm_lang$core$Basics$toFloat(model.t) * 0.5;
		var rotation = A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(thetaR),
			' 50 50');
		var hue = A2(_elm_lang$core$Basics_ops['%'], model.t + (j * 30), 360);
		var y1 = _elm_lang$core$Basics$toFloat((((j * 10) / 100) | 0) * 10) + 0.5;
		var x1 = _elm_lang$core$Basics$toFloat(
			A2(_elm_lang$core$Basics_ops['%'], j * 10, 100)) + 0.5;
		return A2(
			_elm_lang$svg$Svg$rect,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$svg$Svg_Attributes$width('9'),
...
var _elm_lang$elm_architecture_tutorial$Design$elements = function (model) {
	return A2(
		_elm_lang$core$List$indexedMap,
		_elm_lang$elm_architecture_tutorial$Design$element,
		A2(_elm_lang$core$List$repeat, 100, model));
};
var _elm_lang$elm_architecture_tutorial$Design$background = A2(
	_elm_lang$svg$Svg$rect,
	_elm_lang$core$Native_List.fromArray(
		[
	...
	_elm_lang$core$Native_List.fromArray(
		[]));
var _elm_lang$elm_architecture_tutorial$Design$design = function (model) {
	return _elm_lang$core$List$concat(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$core$Native_List.fromArray(
				[_elm_lang$elm_architecture_tutorial$Design$background]),
				_elm_lang$elm_architecture_tutorial$Design$elements(model)
			]));
};
...
var _elm_lang$elm_architecture_tutorial$View$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$id('main-canvas'),
				_elm_lang$svg$Svg_Attributes$viewBox('0 0 100 100'),
				_elm_lang$svg$Svg_Attributes$width('100%')
			]),
		_elm_lang$elm_architecture_tutorial$Design$design(model));
};

var _elm_lang$elm_architecture_tutorial$Update$interate = function (model) {
...
var _elm_lang$elm_architecture_tutorial$Update$update = F2(
	function (msg, model) {
		...
		if (_p0.ctor === 'Tick') {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$elm_architecture_tutorial$Update$interate(
					_elm_lang$core$Native_Utils.update(
						model,
