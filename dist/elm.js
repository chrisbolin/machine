...
var _elm_lang$elm_architecture_tutorial$One$element = F2(
	function (j, model) {
...
var _elm_lang$elm_architecture_tutorial$One$elements = function (model) {
	return A2(
		_elm_lang$core$List$indexedMap,
		_elm_lang$elm_architecture_tutorial$One$element,
		A2(_elm_lang$core$List$repeat, 100, model));
};
var _elm_lang$elm_architecture_tutorial$One$background = A2(
	_elm_lang$svg$Svg$rect,
	_elm_lang$core$Native_List.fromArray(
		[
	...
	_elm_lang$core$Native_List.fromArray(
		[]));
var _elm_lang$elm_architecture_tutorial$One$design = function (model) {
	return _elm_lang$core$List$concat(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$core$Native_List.fromArray(
				[_elm_lang$elm_architecture_tutorial$One$background]),
				_elm_lang$elm_architecture_tutorial$One$elements(model)
			]));
};
...
var _elm_lang$elm_architecture_tutorial$View$view = function (model) {
	return A2(
		...
		_elm_lang$elm_architecture_tutorial$One$design(model));
};
