...
var _elm_lang$elm_architecture_tutorial$Model$initialModel = {intervalLengthMs: 0, theta: 4};
var _elm_lang$elm_architecture_tutorial$Model$Model = F2(
	function (a, b) {
		return {intervalLengthMs: a, theta: b};
	});

var _elm_lang$elm_architecture_tutorial$Design$view = function (model) {
	return _elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$svg$Svg_Attributes$fill('pink'),
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$elm_architecture_tutorial$Design$view(model))
			]));
};
